...
function ListingPage2() {
    ...
    let { category,setCategory } = useContext(listingDataContex)
  return (
    ...
    <div className='max-w-[900px] w-[100%] h-[550px] overflow-auto bg-white flex items-center justify-start flex-col gap-[40px] md:[30px]'>
        <h1 className='text-[18px] text-[black] md:text-[30px] px-[10px]'>Which is these best describes your place</h1>
